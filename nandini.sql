...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 05, 2025 at 09:42 AM
...
INSERT INTO `cart` (`id`, `user_id`, `session_id`, `product_id`, `variant_id`, `variant_options`, `quantity`, `price`, `created_at`, `updated_at`) VALUES
(111, 13, NULL, 46, NULL, NULL, 5, 80.00, '2025-08-01 10:25:36', '2025-08-05 06:38:40');
...
(31, '2025-01-28-130000', 'App\\Database\\Migrations\\AddCustomJsSettings', 'default', 'App', 1754029983, 19),
(36, '2025-08-01-000001', 'App\\Database\\Migrations\\RemovePaymentFieldsFromOrders', 'default', 'App', 1754047007, 20),
(37, '2025-08-01-000002', 'App\\Database\\Migrations\\DropPaymentTransactionsTable', 'default', 'App', 1754047007, 20),
(38, '2025-08-01-000003', 'App\\Database\\Migrations\\CreatePaymentMethodsTable', 'default', 'App', 1754048359, 21),
(39, '2025-08-01-000004', 'App\\Database\\Migrations\\AddPaymentMethodToOrders', 'default', 'App', 1754048359, 21),
(40, '2025-08-01-000005', 'App\\Database\\Migrations\\AddPaymentScreenshotToOrders', 'default', 'App', 1754372226, 22);
...
CREATE TABLE `orders` (
  ...
  `payment_screenshot` varchar(500) DEFAULT NULL COMMENT 'Path to payment proof screenshot uploaded by customer',
  `payment_verified` tinyint(1) DEFAULT 0 COMMENT 'Whether admin has verified the payment screenshot',
  `payment_verified_at` datetime DEFAULT NULL COMMENT 'When the payment was verified by admin',
  `payment_verified_by` int(11) UNSIGNED DEFAULT NULL COMMENT 'Admin user ID who verified the payment',
...
INSERT INTO `orders` (`id`, `user_id`, `order_number`, `status`, `total_amount`, `coupon_id`, `coupon_code`, `shipping_amount`, `shipping_method_id`, `payment_method_id`, `payment_status`, `payment_screenshot`, `payment_verified`, `payment_verified_at`, `payment_verified_by`, `tax_amount`, `discount_amount`, `subtotal_amount`, `shipping_address`, `billing_address`, `notes`, `created_at`, `updated_at`) VALUES
(28, 3, 'ORD202508059544', 'delivered', 288.80, NULL, NULL, 100.00, 2, 1, 'paid', 'uploads/payment_screenshots/payment_ORD202508059544_1754372581.jpg', 1, '2025-08-05 05:43:46', 13, 28.80, 0.00, 160.00, 'LGF 10 ANORA KALAN, Near TECHNO COLLAGE, Lucknow, Uttar Pradesh, 226028', 'LGF 10 ANORA KALAN, Near TECHNO COLLAGE, Lucknow, Uttar Pradesh, 226028', '', '2025-08-05 05:42:51', '2025-08-05 06:50:14'),
(29, 3, 'ORD202508059205', 'processing', 196.76, NULL, NULL, 100.00, 2, 1, 'paid', 'uploads/payment_screenshots/payment_ORD202508059205_1754372663.png', 1, '2025-08-05 05:44:41', 13, 14.76, 0.00, 82.00, 'LGF 10 ANORA KALAN, Near TECHNO COLLAGE, Lucknow, Uttar Pradesh, 226028', 'LGF 10 ANORA KALAN, Near TECHNO COLLAGE, Lucknow, Uttar Pradesh, 226028', '', '2025-08-05 05:44:14', '2025-08-05 05:45:13'),
(30, 3, 'ORD202508056844', 'pending', 135.40, NULL, NULL, 100.00, 2, 1, 'pending', NULL, 0, NULL, NULL, 5.40, 0.00, 30.00, 'LGF 10 ANORA KALAN, Near TECHNO COLLAGE, Lucknow, Uttar Pradesh, 226028', 'LGF 10 ANORA KALAN, Near TECHNO COLLAGE, Lucknow, Uttar Pradesh, 226028', '', '2025-08-05 05:52:46', '2025-08-05 05:52:46'),
(31, 3, 'ORD202508055220', 'pending', 94.40, NULL, NULL, 0.00, 4, 1, 'failed', NULL, 0, NULL, NULL, 14.40, 0.00, 80.00, 'LGF 10 ANORA KALAN, Near TECHNO COLLAGE, Lucknow, Uttar Pradesh, 226028', 'LGF 10 ANORA KALAN, Near TECHNO COLLAGE, Lucknow, Uttar Pradesh, 226028', '', '2025-08-05 06:08:06', '2025-08-05 06:15:34'),
(32, 3, 'ORD202508059065', 'pending', 85.40, NULL, NULL, 50.00, 1, 1, 'pending', NULL, 0, NULL, NULL, 5.40, 0.00, 30.00, 'LGF 10 ANORA KALAN, Near TECHNO COLLAGE, Lucknow, Uttar Pradesh, 226028', 'LGF 10 ANORA KALAN, Near TECHNO COLLAGE, Lucknow, Uttar Pradesh, 226028', '', '2025-08-05 06:32:28', '2025-08-05 06:32:28'),
(33, 3, 'ORD202508053651', 'cancelled', 849.60, NULL, NULL, 0.00, 4, 1, 'failed', 'uploads/payment_screenshots/payment_ORD202508053651_1754376003.jpg', 0, '2025-08-05 06:40:25', 13, 129.60, 0.00, 720.00, 'LGF 10 ANORA KALAN, Near TECHNO COLLAGE, Lucknow, Uttar Pradesh, 226028', 'LGF 10 ANORA KALAN, Near TECHNO COLLAGE, Lucknow, Uttar Pradesh, 226028', '', '2025-08-05 06:39:53', '2025-08-05 06:47:51');
...
(53, 31, 46, NULL, NULL, NULL, 'Shop Wonder Psilocybin Milk Chocolate Bar (6000mg)', 'N/A', 1, 80.00, 80.00, '2025-08-05 06:08:06', '2025-08-05 06:08:06'),
(54, 32, 13, NULL, NULL, NULL, 'Buy Florida White Magic Mushrooms Online USA', 'N/A', 1, 30.00, 30.00, '2025-08-05 06:32:28', '2025-08-05 06:32:28'),
(55, 33, 46, NULL, NULL, NULL, 'Shop Wonder Psilocybin Milk Chocolate Bar (6000mg)', 'N/A', 9, 80.00, 720.00, '2025-08-05 06:39:53', '2025-08-05 06:39:53');
...
CREATE TABLE `payment_methods` (
  ...
  `qr_code` varchar(500) DEFAULT NULL COMMENT 'Path to QR code image or QR code data',
  `payment_information` text DEFAULT NULL COMMENT 'Additional payment instructions or information',
  `is_active` tinyint(1) NOT NULL DEFAULT 1,
  `sort_order` int(11) NOT NULL DEFAULT 0,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL
...
INSERT INTO `payment_methods` (`id`, `name`, `wallet_address`, `qr_code`, `payment_information`, `is_active`, `sort_order`, `created_at`, `updated_at`) VALUES
(1, 'Bitcoin (BTC)', 'BX343403340hhj34343434343', 'uploads/qr_codes/1754048930_cb1a7244a79a5d5e455a.png', 'Send Bitcoin to the wallet address shown. Transaction will be confirmed after 1 confirmation.', 1, 1, '2025-08-01 11:39:19', '2025-08-01 11:48:50'),
(2, 'USDT (Tether)', '', '', 'Send USDT to the wallet address shown. Please ensure you are using the correct network (TRC20/ERC20).', 0, 2, '2025-08-01 11:39:19', '2025-08-01 11:39:19'),
(3, 'Ethereum (ETH)', '', '', 'Send Ethereum to the wallet address shown. Transaction will be confirmed after 12 confirmations.', 0, 3, '2025-08-01 11:39:19', '2025-08-01 11:39:19'),
(4, 'BANK TRANSFER', '', NULL, 'Ac No : 216345453153\r\nIBAN NO : ISD1255456556\r\nSWIFT: KKBKINBB', 1, 4, '2025-08-01 11:44:57', '2025-08-01 11:49:01');
...
(14, 'custom_js_enabled', '0', 'boolean', 'Enable or Disable for custom js', '2025-08-01 06:33:03', '2025-08-01 08:09:05'),
(15, 'custom_js_footer', '', 'string', NULL, '2025-08-01 06:33:03', '2025-08-01 08:09:05');
...
(1, 'Standard Shipping', 'Regular delivery service with tracking', '5–7 Business Days', 50.00, 0.00, NULL, 0, 1, 3, '2025-06-29 06:52:46', '2025-08-05 06:38:12'),
(2, 'Express Shipping', 'Fast delivery with priority handling', '1–2 Business Days', 100.00, 0.00, NULL, 0, 1, 2, '2025-06-29 06:52:46', '2025-08-05 06:38:11'),
...
(4, 'Local Pickup', 'Pick up from our store location', 'Same Day', 0.00, 0.00, NULL, 1, 1, 4, '2025-06-29 06:52:46', '2025-08-01 10:23:02');
